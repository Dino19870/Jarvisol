...
// Number of voices in the loaded voice pack (0 if no voice pack is loaded).
int qwen3_tts_voice_pack_n_voices(struct qwen3_tts_context* ctx);

// Returns the name of the i-th voice in the voice pack (0-indexed), or nullptr if out of range.
const char* qwen3_tts_voice_pack_get_voice_name(struct qwen3_tts_context* ctx, int idx);
