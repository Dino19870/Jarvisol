...
MODELS = {
    ...
    "octen-4b": {
        ...
        "license": "apache-2.0",
        "langs": ["multilingual"],
        "desc": "Octen Embedding 4B. Qwen3-based decoder, 2560-dimensional, last-token pooling.",
    },
    "octen-8b": {
    ...
    "qwen3-embed-8b": {
        ...
        "license": "apache-2.0",
        "langs": ["multilingual"],
        "desc": "Qwen3 Embedding 8B. Official Alibaba embedding model, 4096-dimensional last-token pooling.",
    },
    # --- RAG-critical models ---
    "bge-small-en-v1.5": {
