...
Files: `PP-OCRv6_small_rec-f16.gguf`, `PP-OCRv6_small_rec-f32.gguf`,
`PP-OCRv6_small_rec-q8-head.gguf`, and
`PP-OCRv6_small_rec-crispasr-q4_k-policy.gguf`.
...
measured logits cosine is 0.999987.
