...
void main() async {
  final path = r"C:\Users\lansa\OneDrive\Olivier-IA\Desktop\Kay Scarpetta 01 - Postmortem - Patricia Cornwell.epub";
  final service = DocumentSourceService();
  final item = await service.parseFile(path);
  
  // Take first 20,000 characters
  final contextText = item.textContent.substring(0, item.textContent.length > 20000 ? 20000 : item.textContent.length);
  
  final prompt = """Tu es un assistant expert. Voici les premiers chapitres du livre :
---
$contextText
---
