  ...
  group('BatchQueueNotifier persistence', () {
    ...
    tearDown(() async {
      ...
      if (await tempDir.exists()) {
        // Windows: Defender or shell-extension DLLs may briefly hold
        // a newly-written file after the Dart handle is released.
        // Retry up to 5× with 100 ms backoff — enough for Defender to
        // finish without making the tearDown meaningfully slower.
