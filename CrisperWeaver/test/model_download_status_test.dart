...
void main() {
  ...
  setUp(() async {
    ...
    // Pointer AppPaths vers le répertoire temporaire so que whisperCppDir()
    // et tous les chemins dérivés de dataDir résolvent dans tmpDir — garantit
    // un dossier modèles vide et déterministe sans dépendre du SDK Flutter.
