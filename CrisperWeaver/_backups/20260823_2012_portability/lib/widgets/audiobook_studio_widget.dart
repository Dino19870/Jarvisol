...
class _AudiobookStudioWidgetState extends ConsumerState<AudiobookStudioWidget>
  ...
  Map<String, String> _getAvailableVoices() {
...
— Reste derrière moi, ordonna John en avançant vers la porte.''',
  ...
  Future<void> _testVoice(String voiceModelName, {AudiobookSpeaker? speaker}) async {
    ...
    try {
      ...
      if (voiceModelName == 'custom-clone' || voiceModelName == 'custom-clone-new' || voiceModelName.startsWith('clone_') || (speaker != null && speaker.customVoiceWavPath != null && speaker.customVoiceWavPath!.isNotEmpty)) {
        final svc = ref.read(audiobookServiceProvider);
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            // Badge voix clonée : chemin du WAV + bouton ouvrir dossier
                                            if (activeClone != null) ...[
                                              const SizedBox(height: 4),
                                              Row(
                                                children: [
                                                  const Icon(Icons.mic, size: 11, color: Colors.pinkAccent),
                                                  const SizedBox(width: 4),
                                                  Expanded(
                                                    child: Text(
                                                      activeClone.wavPath,
                                                  ...
                                                  // Supprimer la voix clonée du profil global
                                                  InkWell(
