...
abstract final class ModelCatalog {
  ...
  static const Map<String, ModelDefinition> crispasrBackendModels = {
    ...
    'qwen3-tts-12hz-0.6b-base': ModelDefinition(
      ...
      checksum: '',
      description:
          'Qwen3-TTS base — clonage vocal depuis fichier WAV de référence',
      quantization: 'f16',
      backend: 'qwen3-tts',
      kind: ModelKind.tts,
    ...
    // Piper French voices (rhasspy/piper-voices) — high quality for audiobooks and dialogues
    'piper-fr-siwis-medium': ModelDefinition(
      name: 'piper-fr-siwis-medium',
      displayName: 'Piper fr_FR Siwis (medium — Voix Féminine)',
      fileName: 'piper-fr_FR-siwis-medium.onnx',
      url:
          'https://huggingface.co/rhasspy/piper-voices/resolve/main/fr/fr_FR/siwis/medium/fr_FR-siwis-medium.onnx',
      sizeBytes: 63385600,
      checksum: '',
      description: 'Piper VITS TTS — Français (Siwis, voix féminine claire et posée, idéale pour livre audio, ~63 Mo).',
      quantization: 'onnx',
      backend: 'piper',
      kind: ModelKind.tts,
      languages: langsFr,
    ),
    'piper-fr-upmc-medium': ModelDefinition(
      name: 'piper-fr-upmc-medium',
      displayName: 'Piper fr_FR UPMC (medium — Voix Masculine)',
      fileName: 'piper-fr_FR-upmc-medium.onnx',
      url:
          'https://huggingface.co/rhasspy/piper-voices/resolve/main/fr/fr_FR/upmc/medium/fr_FR-upmc-medium.onnx',
      sizeBytes: 63385600,
      checksum: '',
      description: 'Piper VITS TTS — Français (UPMC, voix masculine naturelle et narrative, ~63 Mo).',
      quantization: 'onnx',
      backend: 'piper',
      kind: ModelKind.tts,
      languages: langsFr,
    ),
    'piper-fr-tom-medium': ModelDefinition(
      name: 'piper-fr-tom-medium',
      displayName: 'Piper fr_FR Tom (medium — Voix Masculine)',
      fileName: 'piper-fr_FR-tom-medium.onnx',
      url:
          'https://huggingface.co/rhasspy/piper-voices/resolve/main/fr/fr_FR/tom/medium/fr_FR-tom-medium.onnx',
      sizeBytes: 63385600,
      checksum: '',
      description: 'Piper VITS TTS — Français (Tom, voix masculine jeune et expressive pour dialogues, ~63 Mo).',
      quantization: 'onnx',
      backend: 'piper',
      kind: ModelKind.tts,
      languages: langsFr,
    ),
    'piper-fr-gilles-low': ModelDefinition(
      name: 'piper-fr-gilles-low',
      displayName: 'Piper fr_FR Gilles (low — Voix Masculine)',
      fileName: 'piper-fr_FR-gilles-low.onnx',
      url:
          'https://huggingface.co/rhasspy/piper-voices/resolve/main/fr/fr_FR/gilles/low/fr_FR-gilles-low.onnx',
      sizeBytes: 31369856,
      checksum: '',
      description: 'Piper VITS TTS — Français (Gilles, voix masculine mûre et posée, ~31 Mo).',
      quantization: 'onnx',
      backend: 'piper',
      kind: ModelKind.tts,
      languages: langsFr,
    ...
    'kokoro-voice-ff_siwis': ModelDefinition(
      ...
      displayName: 'Kokoro voice — ff_siwis (Français)',
      fileName: 'kokoro-voice-ff_siwis.gguf',
      url:
          'https://huggingface.co/cstr/kokoro-voices-GGUF/resolve/main/kokoro-voice-ff_siwis.gguf',
      sizeBytes: 1 * 1024 * 1024,
      checksum: '',
      description: 'Kokoro voicepack — Français (ff_siwis, voix féminine claire)',
      quantization: 'f16',
      backend: 'kokoro',
      kind: ModelKind.voice,
      languages: langsFr,
