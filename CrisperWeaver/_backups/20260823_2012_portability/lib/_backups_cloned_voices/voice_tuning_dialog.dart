              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    if (_selectedVoiceModel == 'custom-clone' || _customVoiceWavPath != null) ...[
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                const Text('Clonage Vocal Instantané', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                                const Spacer(),
                                OutlinedButton.icon(
                ...
                FilledButton.icon(
                  ...
                  onPressed: () {
                    ...
                    if (widget.speaker.id == 'narrator') {
                      settings.defaultNarratorVoice = _selectedVoiceModel;
                    } else if (widget.speaker.role == 'male') {
                      settings.defaultMaleVoice = _selectedVoiceModel;
                    } else if (widget.speaker.role == 'female') {
                      settings.defaultFemaleVoice = _selectedVoiceModel;
                    }
