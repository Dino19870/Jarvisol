...
import 'multi_image_edit_widget.dart';
...
class _TranscriptionOutputWidgetState
        ...
        children: [
          TabBar(
            ...
            tabs: [
              ...
              const Tab(text: '🎨 Composition Multi-Images'),
                ...
                if (id != null) {
                  try {
                    final entry = HistoryEntry(
                      ...
                      engineId: 'crispasr',
                      segments: st.segments,
                      fullTextOverride: st.currentTranscription,
                      speakerNames: st.speakerNames,
                    );
                    await ref
  ...
  Future<void> _runLlmPass(CloudLlmConfig cfg) async {
    ...
    try {
      ...
      if (mounted) {
        messenger.showSnackBar(SnackBar(
          content: Text('Échec du nettoyage LLM : ${e.message} (texte original conservé).'),
