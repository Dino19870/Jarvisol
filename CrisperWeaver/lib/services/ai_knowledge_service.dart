...
class AiKnowledgeService {
  ...
  Future<Directory> getEffectiveStorageDir() async {
    ...
    return AppPaths.aiKnowledgeDir;
  }
        ...
        if (entity is File && entity.path.endsWith('.json')) {
          try {
            ...
            if (json is Map<String, dynamic>) {
              ...
              throw const FormatException('Expected JSON map for AiKnowledgeRecord');
            }
          } catch (e) {
            ...
            try {
              ...
              final corruptPath = '${entity.path}.bak_corrupt_$ts';
              await entity.rename(corruptPath);
              Log.instance.w('ai_knowledge', 'Quarantined corrupted record file to $corruptPath');
            } catch (qErr) {
              Log.instance.e('ai_knowledge', 'Failed to quarantine corrupted record: $qErr');
            }
          }
        }
      }
