...
class AudiobookSpeaker {
  final String id;
  final String name;
  final String voiceModelName; // e.g. 'kokoro-voice-ff_siwis', 'qwen3-ryan', etc.
...
/// A persistent saved cloned voice profile from reference audio.
class ClonedVoiceProfile {
  ...
  factory ClonedVoiceProfile.fromJson(Map<String, dynamic> json) =>
      ClonedVoiceProfile(
        ...
        name: json['name'] as String? ?? 'Voix Clonée',
