...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get voiceCloneRefTextHelp =>
      'Enter the exact transcript of the reference clip. Required for Qwen3-TTS Base and VibeVoice 1.5B. Some other backends may not require a reference transcript.';
  ...
  String get voiceCloneHandoffModelHint =>
      'Tip: Qwen3-TTS Base and VibeVoice 1.5B require the reference transcript; some other backends (e.g. chatterbox) clone from audio alone.';
  ...
  String get synthRefTextRequired =>
      'Add the exact transcript of the reference audio file.';
  ...
  String get voiceBakePythonHelper =>
      'Uses the portable Python runtime packaged under Release. Override only for development if you use a separate venv.';
  ...
  String get voiceBakeScriptHelper =>
      'Uses Release/tools/voice_bake/bake-chatterbox-voice-from-wav.py. Override only for development if needed.';
