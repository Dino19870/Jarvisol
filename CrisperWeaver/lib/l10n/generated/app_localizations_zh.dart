...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String get voiceCloneRefTextHelp =>
      '请输入参考片段的精确逐字转录。Qwen3-TTS Base 和 VibeVoice 1.5B 必须提供。某些其他后端可能不需要参考转录。';
  ...
  String get voiceCloneHandoffModelHint =>
      '提示：Qwen3-TTS Base 和 VibeVoice 1.5B 需要参考转录；某些其他后端（如 chatterbox）仅从音频克隆。';
  ...
  @override
  String get synthRefTextRequired => '请添加参考音频文件的精确转录。';
  ...
  String get voiceBakePythonHelper =>
      '使用 Release 中打包的便携 Python 运行时。仅在开发时使用独立 venv 才需要覆盖。';
  ...
  String get voiceBakeScriptHelper =>
      '使用 Release/tools/voice_bake/bake-chatterbox-voice-from-wav.py。仅在开发时按需覆盖。';
