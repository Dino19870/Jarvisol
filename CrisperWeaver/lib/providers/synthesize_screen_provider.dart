...
class SynthesizeScreenState {
  ...
  final List<ImportedVoicePack> importedVoices;
  ...
  SynthesizeScreenState copyWith({
    ...
    List<ImportedVoicePack>? importedVoices,
    ...
    bool clearLexicon = false,
      ...
      SynthesizeScreenState(
        ...
        importedVoices: importedVoices ?? this.importedVoices,
      );
}
...
class SynthesizeScreenNotifier
  ...
  void setImportedVoices(List<ImportedVoicePack> v) =>
      state = state.copyWith(importedVoices: v);
