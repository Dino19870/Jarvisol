...
class TranscriptionScreenState {
  ...
  final int? diarizationMinSpeakers;
  final int? diarizationMaxSpeakers;
  ...
  const TranscriptionScreenState({
    ...
    this.diarizationMinSpeakers,
    this.diarizationMaxSpeakers,
    this.language = 'auto',
    this.modelName = 'base',
  ...
  TranscriptionScreenState copyWith({
    ...
    bool clearDiarizationMinSpeakers = false,
    bool clearDiarizationMaxSpeakers = false,
  }) =>
      TranscriptionScreenState(
        ...
        diarizationMinSpeakers: clearDiarizationMinSpeakers
            ? null
            : (diarizationMinSpeakers ?? this.diarizationMinSpeakers),
        diarizationMaxSpeakers: clearDiarizationMaxSpeakers
            ? null
            : (diarizationMaxSpeakers ?? this.diarizationMaxSpeakers),
...
class TranscriptionScreenNotifier
  ...
  void setDiarizationMinSpeakers(int? v) => state = state.copyWith(
      diarizationMinSpeakers: v, clearDiarizationMinSpeakers: v == null);
  void setDiarizationMaxSpeakers(int? v) => state = state.copyWith(
      diarizationMaxSpeakers: v, clearDiarizationMaxSpeakers: v == null);
