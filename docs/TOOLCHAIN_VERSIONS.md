...
| **Python** | Compilation serveurs auxiliaires (Full Release) | 3.10+ | 3.11.15 |
| **PyInstaller** | Packaging standalone des helpers (Full Release) | 6.0+ | 6.22.2 |
...
4. **Python & PyInstaller** : Requis pour la cible `-FullRelease` afin de produire `memory_server.exe`, `sd_server.exe` et `jarvisol_tray.exe`.
